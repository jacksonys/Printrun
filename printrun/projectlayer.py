...
class SettingsFrame(wx.Frame):
    ...
    def __init__(self, parent, printer = None):
        ...
        self.direction = wx.ComboBox(self.panel, -1, choices = ["Top Down", "Bottom Up", "SunWit", "LCD continuous print"], value = self._get_setting('project_direction', "Top Down"), size = (80, -1))
